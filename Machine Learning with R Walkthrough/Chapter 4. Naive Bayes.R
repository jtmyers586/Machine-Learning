...
# Building a Naive Bayes model: Spam or Ham


# read the sms data into the sms data frame
sms_raw <- read.delim("C:/Users/jomyers/Desktop/Machine Learning with R Walkthrough/SMSSpamCollection.txt", stringsAsFactors = FALSE)
str(sms_raw)
